...
struct RenderTargetExample {
	...
	zest_texture_handle top_target;						//Render target to draw the result of the blur effect on top of the other layers
	zest_texture_handle base_target;						//The base target to draw the initial images that will be blurred
	zest_texture_handle final_blur;						//Render target where the final blur effect happens
	zest_texture_handle downsampler;						//Render target where the bloom pass happens to filter out dark colors
	zest_texture_handle upsampler;							//Render target where the bloom pass happens to filter out dark colors
	zest_texture_handle compositor;						//Render target to combine the base target with the final blur
	zest_texture_handle tonemap;							//Render target to tonemap the composted base and blur/bloom layers
	...
	zest_texture_handle texture;				            //A texture to store the images
