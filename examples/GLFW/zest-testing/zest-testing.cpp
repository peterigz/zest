...
void InitImGuiApp(ImGuiApp* app) {
	...
	app->floor_texture = zest_CreateTexture("Floor texture", zest_texture_storage_type_bank, zest_image_flag_use_filtering, zest_format_r8g8b8a8_unorm, 10);
	...
	app->sprite_texture = zest_CreateTexture("Sprite texture", zest_texture_storage_type_bank, zest_image_flag_use_filtering, zest_format_r8g8b8a8_unorm, 10);
	...
	//Move Widget Setup
	zest_mesh x_arrow = zest_CreateCylinder(8, arrow_radius, arrow_length, zest_ColorSet(255, 0, 0, 255), 0);
	zest_mesh x_arrow_pointer = zest_CreateCone(8, point_radius, point_length, zest_ColorSet(255, 0, 0, 255));
	zest_mesh x_arrow_block = zest_CreateCube(point_radius * 2.f, zest_ColorSet(255, 0, 0, 255));
	zest_mesh y_arrow = zest_CreateCylinder(8, arrow_radius, arrow_length, zest_ColorSet(0, 255, 0, 255), 0);
	zest_mesh y_arrow_pointer = zest_CreateCone(8, point_radius, point_length, zest_ColorSet(0, 255, 0, 255));
	zest_mesh y_arrow_block = zest_CreateCube(point_radius * 2.f, zest_ColorSet(0, 255, 0, 255));
	zest_mesh z_arrow = zest_CreateCylinder(8, arrow_radius, arrow_length, zest_ColorSet(0, 0, 255, 255), 0);
	zest_mesh z_arrow_pointer = zest_CreateCone(8, point_radius, point_length, zest_ColorSet(0, 0, 255, 255));
	zest_mesh z_arrow_block = zest_CreateCube(point_radius * 2.f, zest_ColorSet(0, 0, 255, 255));
	zest_mesh x_plane_mesh = zest_CreateRoundedRectangle(plane_size, plane_size, plane_radius, 8, 1, zest_ColorSet(255, 0, 0, 255));
	zest_mesh y_plane_mesh = zest_CreateRoundedRectangle(plane_size, plane_size, plane_radius, 8, 1, zest_ColorSet(0, 0, 255, 255));
	zest_mesh z_plane_mesh = zest_CreateRoundedRectangle(plane_size, plane_size, plane_radius, 8, 1, zest_ColorSet(0, 255, 0, 255));
	...
	zest_mesh x_scale_arrow = zest_NewMesh();
	zest_mesh y_scale_arrow = zest_NewMesh();
	zest_mesh z_scale_arrow = zest_NewMesh();
	...
	zest_mesh move_mesh = zest_NewMesh();
	...
	zest_mesh scale_mesh = zest_NewMesh();
