...
int main(void) {
	...
	// Configure staging buffer pool for mesh/texture uploads
	zest_SetStagingBufferPoolSize(imgui_app.device, zloc__KILOBYTE(256), zloc__MEGABYTE(128));

	// Create window and context
	zest_window_data_t window_handles = zest_implglfw_CreateWindow(50, 50, 1280, 768, 0, "Instancing Example");
